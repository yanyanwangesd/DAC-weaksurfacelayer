...
!!!!--------------------------- @YWANG, add regolith regime and flexure regime, Nov. 2021 ---------------------------
       logical regolith_regime, flexure_regime ! flag of whether regolith and flexure regime is used
       double precision regolith_time, flexure_time ! the start time of regimes
       double precision k_ratio, regolith_thickness ! ratio of Kbedrock/Kregolith, regolith thickness
       double precision flexure_te ! effective elastic thickness of the lithosphere
!!!!--------------------------- @YWANG, add regolith regime and flexure regime, Nov. 2021 ---------------------------
   ...
   type geom
      ...
      !!!!--------------------------- @YWANG, add regolith regime and flexure regime, Nov. 2021 ---------------------------
      double precision,dimension(:),pointer::dregolith ! depth of regolith layer
      double precision,dimension(:),pointer::flexure  ! flexure uplift rate
!!!!--------------------------- @YWANG, add regolith regime and flexure regime, Nov. 2021 ---------------------------
