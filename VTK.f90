...
!!!!!! @YW add lines to write Z-uplift rate (w), X-advection (u) ang Y-advection (v) file, erodibility
...
write(30,'(a)')'SCALARS erodibility float 1'
write (30,'(a)')'LOOKUP_TABLE default'
do i=1,geometry%nnode
write(30,'(e12.4)') geometry%k(i)
enddo

write(30,'(a)')'SCALARS rainfall float 1'
write (30,'(a)')'LOOKUP_TABLE default'
do i=1,geometry%nnode
...
write(30,'(a)')'SCALARS regolith_depth float 1'
write (30,'(a)')'LOOKUP_TABLE default'
do i=1,geometry%nnode
write(30,'(e12.4)') geometry%dregolith(i)
enddo

write(30,'(a)')'SCALARS flexural_uplift float 1'
write (30,'(a)')'LOOKUP_TABLE default'
do i=1,geometry%nnode
write(30,'(e12.4)') geometry%flexure(i)
enddo
...
write (31,'(a)')'LOOKUP_TABLE default'
do i=1,geometry%nnode
    if(geometry%catchment(i)==0) then
        morphzone(i)=0
    else
        morphzone(i) = geometry%fix(geometry%catchment(i))
    endif
